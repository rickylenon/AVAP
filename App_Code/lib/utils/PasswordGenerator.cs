...
{	
	...
	public static class RandomPasswordGenerator
	{
		public static string GenerateRandomPassword()
		{
			...
			pwdgen.Minimum = int.Parse(System.Configuration.ConfigurationManager.AppSettings["MinimumPasswordSize"].ToString());
			pwdgen.Maximum = int.Parse(System.Configuration.ConfigurationManager.AppSettings["MaximumPasswordSize"].ToString());
			pwdgen.ConsecutiveCharacters = false;
			pwdgen.RepeatCharacters = true;
			return pwdgen.GenerateRandomPassword();
		}
	}
}