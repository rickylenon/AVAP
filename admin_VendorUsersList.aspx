<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="admin_VendorUsersList.aspx.cs" Inherits="admin_VendorUsersList" %>
...
<div class="rounded-corners-top" id="menuAVA">
    ...
    <li onclick="window.location='admin_UsersList.aspx'"><span>List of Users</span></li>
...
<h3 style="margin:10px 0px;">Vendor Users List</h3>
