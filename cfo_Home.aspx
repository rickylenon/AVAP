<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="cfo_Home.aspx.cs" Inherits="cfo_Home" %>
...
<div style="float:left; width:450px; min-height:300px; border-right:#ccc 1px solid; margin:25px 0 0 0px; padding-top:0px;">
  <div style="margin-top:5px;">
	...
	<a href="cfo_VendorList.aspx" style="font-size:16px; font-weight:bold;">Vendors for Approval
	...
	<a href="cfo_VendorListApproved.aspx" style="font-size:16px; font-weight:bold;">Vendors Approved (<asp:Label ID="countApproved" runat="server" Text=""></asp:Label>)</a><br /><br />
	<a href="cfo_VendorDisapproved_List.aspx" style="font-size:16px; font-weight:bold;">Vendors Disapproved (<asp:Label ID="countDisapproved" runat="server" Text=""></asp:Label>)</a><br /><br />
	<a href="cfo_VendorOngoing_Lists.aspx" style="font-size:16px; font-weight:bold;">Ongoing Accreditation  (<asp:Label ID="cfo_VendorOngoing_List_Count" runat="server" Text="0"></asp:Label>)</a><br /><br />
