<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="vmofficer_vendorDetails_Endorsed_View.aspx.cs" Inherits="vmofficer_vendorDetails_Endorsed_View" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
  ...
  <tr>
    <td class="style1" style="width: 68px" valign="top">
        <strong></strong></td>
    ...
    <td class="style1" style="width: 372px">
        ...
        <table style="width: 90%;">
            <tr>
                ...
                <td align="right">MAXIMUM EXPOSURE LIMIT&nbsp;&nbsp;&nbsp;</td>
                <td style="width: 30px">
...
<a href="vmofficer_VendorEndorsed_List.aspx" class="bt1"><span>BACK</span></a>
<br />
<br />
<br />
    </form>
