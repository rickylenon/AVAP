...
public partial class vmofficer_VendorEndorsed_List : System.Web.UI.Page
{
    ...
    protected void gvBids_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("Details"))
        {
            ...
            Session["vendorDetails"] = "vmofficer_vendorDetails_Endorsed_View.aspx";
            Response.Redirect("vmofficer_vendorDetails_Endorsed_View.aspx");
