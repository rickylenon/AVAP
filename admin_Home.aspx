...
<form action="" method="post" name="formVendorInfo" id="formVendorInfo" runat="server">
  ...
  <label for="CompanyName" style="clear:both; width:110px;">CompanyName*</label>
...
<table style="width: 100%;">
    <tr>
      ...
      <asp:SqlDataSource ID="dsUserTypes" runat="server" ConnectionString="<%$ ConnectionStrings:AVAConnectionString %>"
            SelectCommand="SELECT * FROM rfcUserTypes WHERE UserType != 11 AND UserType!=13 AND UserType!=14 AND UserType!=15 ORDER BY UserType">
	    </asp:SqlDataSource>
        </td>
    </tr>
    </table>
