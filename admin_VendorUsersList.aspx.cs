...
public partial class admin_VendorUsersList : System.Web.UI.Page
{
    ...
    protected void gvBids_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("Details"))
        {
            ...
            Session["UserIdVendor"] = e.CommandArgument.ToString().Trim();
            ...
            Response.Redirect("admin_EditVendor.aspx");
