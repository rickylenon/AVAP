    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(IsPostBack)
        {
            if(Request["__EVENTTARGET"].ToString() == "Details" && Request["__EVENTARGUMENT"].ToString()!="")
            {
                ...
                string sCommand = "";
                sCommand = "INSERT INTO tblVendorHistory (VendorId, CompanyName, approvedbyProc, approvedbyProcDate, approvedbyDnb, approvedbyDnbDate, approvedbyVMOfficer, approvedbyVMOfficerDate, approvedbyLegal, approvedbyLegalDate, approvedbyVMTech, approvedbyVMTechDate, approvedbyVMIssue, approvedbyVMIssueDate, approvedbyVMReco, approvedbyVMRecoDate, approvedbyFAALogistics, approvedbyFAALogisticsDate, approvedbyFAAFinance, approvedbyFAAFinanceDate, Status, DateCreated, AuthenticationTicket, IsAuthenticated, clarifiedtoVMRecoBy, clarifiedtoVMRecoDate, paymentProof, clarifiedtoPvmdBy, clarifiedtoPvmdDate, DateSubmittedToDnb, DateAuthenticatedByDnb, NotificationSent, SendToSAP_Status, AccGroup, VendorAlias, VendorCode, PurchasingOrg, CountryCode, Currency, VAT, renewaldate, accrediteddate ) SELECT VendorId, CompanyName, approvedbyProc, approvedbyProcDate, approvedbyDnb, approvedbyDnbDate, approvedbyVMOfficer, approvedbyVMOfficerDate, approvedbyLegal, approvedbyLegalDate, approvedbyVMTech, approvedbyVMTechDate, approvedbyVMIssue, approvedbyVMIssueDate, approvedbyVMReco, approvedbyVMRecoDate, approvedbyFAALogistics, approvedbyFAALogisticsDate, approvedbyFAAFinance, approvedbyFAAFinanceDate, Status, DateCreated, AuthenticationTicket, IsAuthenticated, clarifiedtoVMRecoBy, clarifiedtoVMRecoDate, paymentProof, clarifiedtoPvmdBy, clarifiedtoPvmdDate, DateSubmittedToDnb, DateAuthenticatedByDnb, NotificationSent, SendToSAP_Status, AccGroup, VendorAlias, VendorCode, PurchasingOrg, CountryCode, Currency, VAT, renewaldate, accrediteddate FROM (SELECT * FROM tblVendor WHERE VendorId = " + Arr[0].ToString() + ") t0";
