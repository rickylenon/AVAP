...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width:600px; padding:5px 20px; text-transform:uppercase; background:#29c5ee; margin:0 0 0 70px; color:#FFF" class="rounded-corners-bottom">
      <h1>Welcome to Globe Vendor Accreditation </h1>
    </div>
    ...
    <asp:Label runat="server" ID="txtNote" ForeColor="#FF0000" Style="font-weight: bold"></asp:Label>
      ...
      <div class="clearfix" style="font-size:18px;"><br /><br /><p>Dont have Globe Automated Vendor Accreditation 
...
It is recommended that the prospective vendor check first if its product/service is needed by Globe. Initial evaluation will be conducted and the vendor is advised on the next steps to follow which may include submissions of additional documents and product samples.   A payment of a non-refundable accreditation fee is required for the accreditation process. The amount will be advised once the prospective vendor passes the initial evaluation. Regardless of the result of the evaluation, the applicant vendor will be formally advised <br /><br />
