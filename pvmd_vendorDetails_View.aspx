<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="pvmd_vendorDetails_View.aspx.cs" Inherits="pvmd_vendorDetails_View" %>
...
<div class="separator1"></div>
        <table style="width: 100%;">
            <tr>
                ...
                <br /><asp:Label runat="server" ID="recodate" ></asp:Label><br /><br /><br />
        ...
        <asp:Label ID="FileAttachementLbl" CssClass="fileuploaded1" runat="server" Text="No Attachment" style="float:left; padding-top:3px; display:block"></asp:Label>
                    ...
                    <div class="separator1"></div>
                    <br />
                <br /><asp:Label runat="server" ID="recoby2" Font-Bold="true" ></asp:Label>
                <br /><asp:Label runat="server" ID="recodate2" ></asp:Label><br /><br /><br />
                    <strong><asp:Label ID="recommendation2a" runat="server" Text="This is an endorsement to "></asp:Label><asp:Label ID="recommendation2" runat="server" Text="______" ForeColor="Blue"></asp:Label> the accreditation.</strong><br />
                </td>
            </tr>
        </table>
<br />
