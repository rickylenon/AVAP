<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="pvmd_vendorDetails.aspx.cs" Inherits="vmhead_vendorDetails" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <br />
                    ...
                    <label>Others</label>
                    <div class="clearfix"></div>
                    <%--<textarea id="Others" runat="server" cols="35" rows="4" style="font-family:Arial"></textarea>--%>
