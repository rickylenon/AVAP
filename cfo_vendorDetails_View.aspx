<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSubPage.master" AutoEventWireup="true" CodeFile="cfo_vendorDetails_View.aspx.cs" Inherits="pvmd_vendorDetails_View" %>
...
<div class="separator1"></div>
        <table style="width: 100%;">
            <tr>
                ...
                <br /><asp:Label runat="server" ID="recodate" ></asp:Label><br />
                    <strong><asp:Literal runat="server" ID="OverallEvalRemarks"></asp:Literal></strong>
                    <div class="clearfix"></div>
                <br />
                    <strong>This is a recommedation to <asp:Label ID="recommedation" runat="server" Text="______" ForeColor="Blue"></asp:Label> the accreditation.</strong><br />
                    <div class="clearfix"><br /><br /></div>
        <div style="float:left; width:30px;"><img alt="" src="images/attachment.png" /></div> 
    ...
    <SelectParameters>
        <asp:SessionParameter Name="VendorId" SessionField="VendorId" Type="Int32" />
                ...
                <td valign="top" width="50%">
                    ...
                    <strong><asp:Label ID="recommedation2a" runat="server" Text="This is an endorsement to "></asp:Label><asp:Label ID="recommedation2" runat="server" Text="______" ForeColor="Blue"></asp:Label> the accreditation.</strong><br />
                    <div class="clearfix"></div> 
                    <div class="separator1"></div>
                    <br />

                    <asp:Label runat="server" ID="recoby3" Font-Bold="true" ></asp:Label><br />
                    <asp:Label runat="server" ID="recodate3" ></asp:Label><br />
                    <strong>CFO <asp:Label ID="recommedation3" runat="server" Text="______" ForeColor="Blue"></asp:Label> the accreditation.</strong><br />
